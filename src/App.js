...
import ad from './assets/Ad space.png'
function App() {
  return (
    <div>
    <div className="App" style={{color:'background: #131F2F'}}>
      ...
      <hr style={{display:'flex',width:'1350px',marginTop:'-5000%', borderColor: '#b3a9a2' }} />
      </div>
      <div style={{display:'flex',justifyContent: 'space-between', alignItems: 'center' }}>
      <h style={{ textDecoration: 'underline', color: 'white',marginRight: '20px' }}>HOME</h>
      <h style={{marginRight: '20px'}}>ADVISORY</h>
      <h style={{marginRight: '20px'}}>RESIDENTIAL</h>
      <h style={{marginRight: '20px'}}>COMMERCIAL</h>
      <h style={{marginRight: '20px'}}>MEDIA</h>
      <h>CONTACT US</h>
      </div>
      </header>
    </div>
